...
\newcommand{\WEB}{\href{http://www.ccp5.ac.uk/DL_POLY_CLASSIC/}{http://www.ccp5.ac.uk/DL\_POLY\_CLASSIC/}}
...
Cheshire, UK}
\date{Version 1.0,~~December 2010}
\end{titlepage}
...
\chapter{\D{} Force Fields and Algorithms}
\label{field}
\setcounter{equation}{0}
\newpage
\section*{Scope of Chapter}
...
\input repdata.tex
\newpage
\chapter{\D{} Construction and Execution}
\label{conex}
\setcounter{equation}{0}
\newpage
\section*{Scope of Chapter}
...
besides solutions.  \newpage \input solvation.tex \newpage

\chapter{The \DD Java Graphical User Interface}
\label{java}
\setcounter{equation}{0}
\newpage
\section*{Scope of Chapter}
