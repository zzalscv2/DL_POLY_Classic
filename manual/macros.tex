...
execute} sub-directory\index{sub-directory}. It contains the unix commands:
\begin{verbatim}
#!/bin/tcsh
#
...
data} sub-directory\index{sub-directory}. It invokes the unix
commands:
...
sub-directory\index{sub-directory} and then moves the standard
