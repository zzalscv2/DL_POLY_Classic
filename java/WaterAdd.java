...
*/
	...
	try
	    {
		String record=""; 
		InputStream instream = this.getClass().getResourceAsStream("WATER.300K");
		InputStreamReader isr = new InputStreamReader(instream);
		BufferedReader reader = new BufferedReader(isr);
		monitor.println("Reading file: WATER.300K");
	    ...
	    {
		monitor.println("Error - file not found: WATER.300K");
		return -2;
	    }
	catch(Exception e)
	    {
		monitor.println("Error reading file: WATER.300K"+" "+e);
		return -3;
	    }
