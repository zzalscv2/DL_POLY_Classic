...
class MakeChain extends Super implements ActionListener
{
	/*
*********************************************************************
...
*/
    static GUI home;
    static MakeChain job;
    static JButton make,close;
    static JLabel lab1,lab2,lab3,lab4,lab5,pass;
    static JTextField nc,area,eon,gapz;
    static JCheckBox chk1,chk2;
    static JComboBox head;
    static boolean flip,twin;
    static String hdname;
    static int keyhed,ncarbons,nethos;
    static double zgap,harea;
    static double beta=.615479708;
    static double[] rot,uuu,vvv;
    static double[] xbs,ybs,zbs;
    static double[] cell;
    static double[][] xyz;
...
*/
	...
	//        Head group area
        ...
        area.setBackground(scrn);
        area.setForeground(scrf);
	...
	//        Head group choice
        ...
        head = new JComboBox();
        head.setBackground(scrn);
        head.setForeground(scrf);
	head.addItem("None");
	head.addItem("Soap");
	...
	//        Number of (EO)n groups
        ...
        eon.setBackground(scrn);
        eon.setForeground(scrf);
        fix(eon,grd,gbc,2,5,1,1);
        
	//        Twin checkbox
	
        chk1 = new JCheckBox("Twin");
        chk1.setBackground(back);
        chk1.setForeground(fore);
	fix(chk1,grd,gbc,0,6,1,1);
        
	//        Flip checkbox
	
        chk2 = new JCheckBox("Flip");
        chk2.setBackground(back);
        chk2.setForeground(fore);
	...
	//        Z - gap between twins
        ...
        gapz.setBackground(scrn);
        gapz.setForeground(scrf);
...
*/
	...
	monitor.println("Activated panel for making chain polymer CONFIG file");
	home=here;
...
*/
	...
	if(keyhed==1)
	    ...
	    {
		hdname="Trimethylammonium Bromide";
		natms=trimethyl();
	    }	
	else if(keyhed==5)
	    {
	...
	config.cell=cell;
	config.xyz=xyz;
	config.title="Chain polymer with"+BML.fmt(ncarbons,4)+" units and "+hdname+" Head Group";
	config.boxCELL();
