...
public class BondLengths extends Super implements ActionListener
{
	    /*
**********************************************************************
...
*/
	    ...
	    b01.setBackground(scrn);
	    b01.setForeground(scrf);
	    ...
	    b02.setBackground(scrn);
	    b02.setForeground(scrf);
	    ...
	    b03.setBackground(scrn);
	    b03.setForeground(scrf);
	    ...
	    b04.setBackground(scrn);
	    b04.setForeground(scrf);
	    ...
	    b05.setBackground(scrn);
	    b05.setForeground(scrf);
	    ...
	    b06.setBackground(scrn);
	    b06.setForeground(scrf);
	    ...
	    b07.setBackground(scrn);
	    b07.setForeground(scrf);
	    ...
	    b08.setBackground(scrn);
	    b08.setForeground(scrf);
	    ...
	    b09.setBackground(scrn);
	    b09.setForeground(scrf);
	    ...
	    b10.setBackground(scrn);
	    b10.setForeground(scrf);
	    ...
	    b11.setBackground(scrn);
	    b11.setForeground(scrf);
	    ...
	    b12.setBackground(scrn);
	    b12.setForeground(scrf);
	    ...
	    b13.setBackground(scrn);
	    b13.setForeground(scrf);
	    ...
	    b14.setBackground(scrn);
	    b14.setForeground(scrf);
...
*/
	home=here;
	monitor.println("Activated panel for bondlength adjustment");
	job=new BondLengths();
	job.pack();
	job.show();
	bondLengthSet();
...
*/
	...
	if (arg.equals("Set"))
		...
		monitor.println("Bondlengths now reset");
	    }
