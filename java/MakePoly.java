...
public class MakePoly extends Super implements ActionListener
{
	/*
*********************************************************************
...
*/
    static GUI home;
    static MakePoly job;
    static double ccbond,chbond,ebond,dihscl,heng,volm,temp,size;
    static double[] eps,sig,edih;
    static int ncarbons,natms;
    static JButton make,close;
    static JCheckBox pbc;
    static JTextField nc,svol,stem,ccb,chb,cce,che,hhe,ccs,chs,hhs;
    static JTextField ccbe,de1,de2,de3,de4,dhs;
    static boolean lrej,lpbc;
    static double[] cell;
    static double[][] xyz;
...
*/
	...
	//        Number of C atoms
        ...
        nc = new JTextField(8);
        nc.setBackground(scrn);
        nc.setForeground(scrf);
	...
	//        System Volume
        ...
        svol.setBackground(scrn);
        svol.setForeground(scrf);
        fix(svol,grd,gbc,0,4,1,1);
        
	//       System Temperature
	
        stem = new JTextField(8);
        stem.setBackground(scrn);
        stem.setForeground(scrf);
	...
	//        C-C Bondlength
        ...
        ccb.setBackground(scrn);
        ccb.setForeground(scrf);
        fix(ccb,grd,gbc,0,6,1,1);
        
	//        C-H Bondlength
	
        chb = new JTextField(8);
        chb.setBackground(scrn);
        chb.setForeground(scrf);
	...
	//        C-C Epsilon
        ...
        cce.setBackground(scrn);
        cce.setForeground(scrf);
        fix(cce,grd,gbc,0,8,1,1);
        
	//        C-H Epsilon
	
        che = new JTextField(8);
        che.setBackground(scrn);
        che.setForeground(scrf);
        fix(che,grd,gbc,1,8,1,1);
        
	//        H-H Epsilon
	
        hhe = new JTextField(8);
        hhe.setBackground(scrn);
        hhe.setForeground(scrf);
	...
	//        C-C Sigma
        ...
        ccs.setBackground(scrn);
        ccs.setForeground(scrf);
        fix(ccs,grd,gbc,0,10,1,1);
        
	//        C-H Sigma
	
        chs = new JTextField(5);
        chs.setBackground(scrn);
        chs.setForeground(scrf);
        fix(chs,grd,gbc,1,10,1,1);
        
	//        H-H Sigma
	
        hhs = new JTextField(5);
        hhs.setBackground(scrn);
        hhs.setForeground(scrf);
        fix(hhs,grd,gbc,2,10,1,1);
        
	//        C-C Bond Energy
	
        ccbe = new JTextField(5);
        ccbe.setBackground(scrn);
        ccbe.setForeground(scrf);
	...
	pbc.setBackground(back);
        pbc.setForeground(fore);
...
*/
	...
	monitor.println("Activated panel for making amorphous polymer CONFIG files");
	this.home=home;
...
*/
	...
	euler(alp,bet,gam,rot);
	uuu[0]=xbs[0];
	uuu[1]=ybs[0];
	uuu[2]=zbs[0];
	rotate(opr,uuu,vvv,rot);
...
*********************************************************************
     ...
     copyright daresbury laboratory march 1995
