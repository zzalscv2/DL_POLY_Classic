...
public class Nfold extends Super implements ActionListener
{
    /*
*********************************************************************
...
*********************************************************************
*/
    static int nxnum,nynum,nznum;
    static double zgap;
    static JCheckBox twin,show;
    static JButton make,load,close;
    static JTextField nx,ny,nz,gap;
    static Nfold job;
    static boolean ltwin,lshow,lgetf;
...
*/
	...
	twin = new JCheckBox("Z-Bilayer");
        twin.setBackground(back);
        twin.setForeground(fore);
	...
	// Z gap
        ...
        gap.setBackground(scrn);
        gap.setForeground(scrf);
	...
	show = new JCheckBox("Show CFG.");
        show.setBackground(back);
        show.setForeground(fore);
...
*********************************************************************
*/
	monitor.println("Activated panel for N-fold expansion of a CONFIG file");
	home=here;
...
*/
	...
	double xx,yy,zz,wdth,det,rrr,ttt,ca,sa;
	...
	monitor.println("Number of atoms in CONFIG file: "+natms);
	...
	if(ltwin)
		...
		if(imcon==0 || imcon==4 || imcon==5)
		    {
			monitor.println("Error - bilayer not possible for this PBC");
			return -2;
		    }
	...
	monitor.println("Number of atoms in "+fname+" : "+cfgbig.natms);
	monitor.println("Maximum cutoff radius = "+BML.fmt(wdth,10));
